...
function addNewNote(className, title, content) {
	...
	notes.append("<li><div class='" + className + "'>" + 
					...
					"<textarea class='note-content' placeholder='Type your content here'/>" + 
					"<img class='hide' src='http://www.drodd.com/images14/x23.png ' width='25' height='30'/>" + 
                    " <button  click='saveNotes()' class='button'>save</button>"+
					"</div>"+
                     "</li>"
